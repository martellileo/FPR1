...
import br.edu.ifsp.pep.modelos.PessoaFisica;
import br.edu.ifsp.pep.modelos.PessoaJuridica;
import br.edu.ifsp.pep.modelos.Proprietario;
import br.edu.ifsp.pep.modelos.Revisao;
...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        adicionar(2014, "Porsche", "ABC-1234", "Presidente Prudente", retornaProp());
        adicionar(2000, "Chevrolet", "CBA-4321", "Presidente Epitácio", retornaProp());
        adicionar(2010, "Lamborghini", "ABC-1111", "Presidente Epitácio", retornaProp());
        adicionar(2002, "Honda", "ABC-2222", "Presidente Prudente", retornaProp());
        adicionar(1987, "Chevrolet", "ABC-3333", "Presidente Venceslau", retornaProp());
    ...
    private static void adicionarPessoaFisica() {
        Proprietario p1 = new PessoaFisica("123213", "Natalia");        
    ...
    private static void adicionarPessoaJuridica() {
        Proprietario p1 = new PessoaJuridica("123", "IFSP");
    ...
    private static Proprietario retornaProp() {
        EntityManager em = emf.createEntityManager();
        
        TypedQuery<Proprietario> query = em.createQuery("SELECT p from Proprietario p WHERE p.codigo = 1", Proprietario.class);
        Proprietario p = query.getSingleResult();
